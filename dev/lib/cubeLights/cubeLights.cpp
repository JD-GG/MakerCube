...
RgbColor orange(colorSaturation, colorSaturation / 2,
                0); // Orange (Mehr Rot als Grün)
RgbColor pink(colorSaturation, colorSaturation / 3,
              colorSaturation / 2); // Pink (Rot + wenig Blau)
RgbColor lime(colorSaturation / 2, colorSaturation,
              0); // Limettengrün (Mehr Grün als Rot)
RgbColor turquoise(0, colorSaturation / 2,
                   colorSaturation); // Türkis (Mehr Blau als Grün)
RgbColor violet(colorSaturation / 2, 0,
                colorSaturation); // Violett (Mehr Blau als Rot)
...
void setLight(char direction, int ledNum,
              RgbColor color) { // Din A4 Dokumentation mit LED nummerierung
...
void Player::drawPLayer() { setLight(side, ledNum, color); }
...
void Player::moveRight() {
    strip.SetPixelColor(calcLedInArr(side, ledNum),
                        black); // Clear previous position
